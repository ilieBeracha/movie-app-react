...
function MoviesContent(): JSX.Element {
    ...
    return (
        <div className="MoviesContent">
            ...
            <div className="MoviesContentTrending">
                <h3>Trending: </h3>
                <div className="MovieContentTrendingBtns">
            ...
            {/* <div className="MoviesContentMoreFeatures">
                <div className="MoviesContentMoreFeatures1"></div>
                <div className="MoviesContentMoreFeatures2"></div>
            </div> */}
        </div>
    );
}
